    ...
    <>
      <footer className="footer_container">
        ...
        <div className="F_elem_2">
          ...
          <div className="logos">
            <FaFacebookF color="white" className="F_logos" />
            <FaLinkedin color="white" className="F_logos" />
            <FaInstagram color="white" className="F_logos" />
            <FaTwitter color="white" className="F_logos" />
            <FaYoutube color="white" className="F_logos" />
            <FaQuora color="white" className="F_logos" />
          </div>
        </div>
